...
public class P209 {
    ...
    public static void main(String[] args) {
        ...
        P209 p209 = new P209();
        System.out.printf("The mini length is %d", p209.minSubArrayLen(target, nums));
    }

    public int minSubArrayLen(int target, int[] nums) {
        /**
         * step1:
         *  clarify the problem & identify the constraints
         *      1. find the minimal length of subarray
         *      2. the constraint is the sum of the subarray is not less than target
         *      3. extra info is if there is no subarray which satisfy this constraint, we can return 0
         *
         * Step2:
         *  give the approach step by step
         *      We can use the sliding window to solve this problem.
         *      1. two variables
         *          curr_left; curr_right;
         *
         * Step3: Time and Space complexity
         *
         * space : O(1)
         * time: O(n)
         */
        ...
        int left = 0;
        int right = 0;
        int sumInTheCurrWindow = 0;
        for (; right < nums.length; right++) {
            //1. expend the window until it satisfies the requirement
            sumInTheCurrWindow += nums[right];
            while (sumInTheCurrWindow >= target) {
                if (length == 0) {
                    //init
                    length = right - left + 1;
                }
